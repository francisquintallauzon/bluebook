...
class conv_maxpool(base):
    def __init__(self, downsample_sz):
        super(conv_maxpool, self).__init__({'downsample_sz':downsample_sz})
        self.downsample_sz=(downsample_sz, downsample_sz) if isinstance(downsample_sz, int) else downsample_sz
